...
cutList = {
	...
	"RecoKaonElecSel":	"1>0",
	"RecoHiggsMassCut":	"RecoHiggs_mass>120",
}

#Dictionary of the labels of cuts.
cutLabels = {
	"RecoKaonElecSel":	"Reco kaon and electron selection",
	"RecoHiggsMassCut":	"Higgs mass > 120 GeV",
}
...
# 	"n_Jets_kt2":						{"name":"n_Jets_kt2",						"title":"Number of Jets",							"bin":50,	"xmin":0,	"xmax":10},
	...
	"RecoHiggs_py":		{"name":"RecoHiggs_py",		"title":"P_{y} of Reco Higgs",		"bin":50,	"xmin":0,	"xmax":90},
	"RecoHiggs_pz":		{"name":"RecoHiggs_pz",		"title":"P_{z} Reco Higgs",			"bin":50,	"xmin":0,	"xmax":90},
	...
	"Kplus_0_pt":	{"name":"Kplus_0_pt",	"title":"P_{t} of 1st K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_0_px":	{"name":"Kplus_0_px",	"title":"P_{x} of 1st K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_0_py":	{"name":"Kplus_0_py",	"title":"P_{y} of 1st K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_0_pz":	{"name":"Kplus_0_pz",	"title":"P_{z} of 1st K+",		"bin":50,	"xmin":0,	"xmax":30},
	...
	"Kplus_1_pt":	{"name":"Kplus_1_pt",	"title":"P_{t} of 2nd K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_1_px":	{"name":"Kplus_1_px",	"title":"P_{x} of 2nd K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_1_py":	{"name":"Kplus_1_py",	"title":"P_{y} of 2nd K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_1_pz":	{"name":"Kplus_1_pz",	"title":"P_{z} of 2nd K+",		"bin":50,	"xmin":0,	"xmax":50},
	...
	"Kplus_2_pt":	{"name":"Kplus_2_pt",	"title":"P_{t} of 3rd K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_2_px":	{"name":"Kplus_2_px",	"title":"P_{x} of 3rd K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_2_py":	{"name":"Kplus_2_py",	"title":"P_{y} of 3rd K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_2_pz":	{"name":"Kplus_2_pz",	"title":"P_{z} of 3rd K+",		"bin":50,	"xmin":0,	"xmax":100},
	...
	"Kplus_3_pt":	{"name":"Kplus_3_pt",	"title":"P_{t} of 4th K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_3_px":	{"name":"Kplus_3_px",	"title":"P_{x} of 4th K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_3_py":	{"name":"Kplus_3_py",	"title":"P_{y} of 4th K+",		"bin":50,	"xmin":0,	"xmax":100},
	"Kplus_3_pz":	{"name":"Kplus_3_pz",	"title":"P_{z} of 4th K+",		"bin":50,	"xmin":0,	"xmax":100},
	...
	"RecoZ_pt":		{"name":"RecoZ_pt",		"title":"P_{t} of Reco Z",		"bin":50,	"xmin":0,	"xmax":90},
	"RecoZ_px":		{"name":"RecoZ_px",		"title":"P_{x} of Reco Z",		"bin":50,	"xmin":0,	"xmax":90},
	"RecoZ_py":		{"name":"RecoZ_py",		"title":"P_{y} of Reco Z",		"bin":50,	"xmin":0,	"xmax":90},
	"RecoZ_pz":		{"name":"RecoZ_pz",		"title":"P_{z} Reco Z",			"bin":50,	"xmin":0,	"xmax":90},
	...
	"Electron_0_pt":	{"name":"Electron_0_pt",	"title":"P_{t} of 1st Electron",	"bin":50,	"xmin":0,	"xmax":90},
	"Electron_0_px":	{"name":"Electron_0_px",	"title":"P_{x} of 1st Electron",	"bin":50,	"xmin":0,	"xmax":90},
	"Electron_0_py":	{"name":"Electron_0_py",	"title":"P_{y} of 1st Electron",	"bin":50,	"xmin":0,	"xmax":90},
	"Electron_0_pz":	{"name":"Electron_0_pz",	"title":"P_{z} of 1st Electron",	"bin":50,	"xmin":0,	"xmax":90},
	...
	"Electron_1_pt":	{"name":"Electron_1_pt",	"title":"P_{t} of 2nd Electron",	"bin":50,	"xmin":0,	"xmax":80},
	"Electron_1_px":	{"name":"Electron_1_px",	"title":"P_{x} of 2nd Electron",	"bin":50,	"xmin":0,	"xmax":80},
	"Electron_1_py":	{"name":"Electron_1_py",	"title":"P_{y} of 2nd Electron",	"bin":50,	"xmin":0,	"xmax":80},
	"Electron_1_pz":	{"name":"Electron_1_pz",	"title":"P_{z} of 2nd Electron",	"bin":50,	"xmin":0,	"xmax":80},
	...
	"RecoEmiss_pt":		{"name":"RecoEmiss_pt",		"title":"P_{t} of Emiss",		"bin":50,	"xmin":0,	"xmax":80},
	"RecoEmiss_px":		{"name":"RecoEmiss_px",		"title":"P_{x} of Emiss",		"bin":50,	"xmin":0,	"xmax":80},
	"RecoEmiss_py":		{"name":"RecoEmiss_py",		"title":"P_{y} of Emiss",		"bin":50,	"xmin":0,	"xmax":80},
	"RecoEmiss_pz":		{"name":"RecoEmiss_pz",		"title":"P_{z} of Emiss",		"bin":50,	"xmin":0,	"xmax":80},
