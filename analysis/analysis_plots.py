...
energy			= 240
collider 		= 'FCC-ee'
inputDir 		= '/ceph/salshamaily/haa4K_FCCee/analysis/final_output/all_samples_mgp8sig_norwt_012026/'
outdir			= '/ceph/salshamaily/haa4K_FCCee/analysis/plots_output/all_samples_mgp8sig_norwt_012026/'
formats			= ['png', 'pdf']
yaxis			= ['log', 'lin']
stacksig		= ['nostack']
stackbkg		= ['stack']
...
colors 					= {}
colors['HAlpAlp_m1']	= ROOT.kRed
colors['HAlpAlp_m3']	= ROOT.kGreen-4
colors['HAlpAlp_m6']	= ROOT.kYellow-7

colors['eeWW']			= ROOT.kBlue-7
colors['eeZqq']			= ROOT.kBlue-4
colors['eeZZ']			= ROOT.kBlue-9
...
plots['HAlpAlp'] = {'signal':{
					...
					'HAlpAlp_m3':['mgp8_ee_eeH_HAlpAlp_m3_ecm240'],
					'HAlpAlp_m6':['mgp8_ee_eeH_HAlpAlp_m6_ecm240'],},
...
legend 					= {}
legend['HAlpAlp_m1']	= 'm_{alp} = 1.5 GeV'
legend['HAlpAlp_m3']	= 'm_{alp} = 30 GeV'
legend['HAlpAlp_m6']	= 'm_{alp} = 60 GeV'
