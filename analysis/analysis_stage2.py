...
class RDFanalysis():
	...
	def analysers(df):
		...
		### KAONS ###
	   	...
	   	# constructing a TLV to apply kaon mass and pt cut
	   	...
	   	.Define("RecoKplus_MassCut",	"RecoKplus_tlv[RecoKplus_tlv_mass>0.4 && RecoKplus_tlv_mass<0.6]")
	   	...
	   	.Filter("RecoKplus_MassCut_pt.at(0) > 1.0")
	   	...
	   	.Define("alp_0_m",		"alp_0.M()")
		.Define("alp_0_e", 		"alp_0.E()")
		.Define("alp_0_p", 		"alp_0.P()")
		.Define("alp_0_pt",		"alp_0.Pt()")
		.Define("alp_0_px",		"alp_0.Px()")
		.Define("alp_0_py",		"alp_0.Py()")
		...
		.Define("alp_1_p", 		"alp_1.P()")
		.Define("alp_1_pt",		"alp_1.Pt()")
		.Define("alp_1_px",		"alp_1.Px()")
		.Define("alp_1_py",		"alp_1.Py()")
		.Define("alp_1_pz",		"alp_1.Pz()")
		.Define("alp_1_eta",	"alp_1.Eta()")
		.Define("alp_1_phi",	"alp_1.Phi()")
